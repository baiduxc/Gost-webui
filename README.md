...
基于 [gost](https://github.com/go-gost/gost) 的**中转机管理面板**：一台服务器一条命令装好，
把落地机的 v2rayN 链接粘进来，就能得到一条客户端可直接使用的新链接；
...
2. 进入 **节点** → **添加节点**
3. 粘贴**落地机**的 v2rayN 分享链接，设置监听端口（可点「随机」）
4. 保存后复制生成的新链接（或扫码）导入客户端即可使用
