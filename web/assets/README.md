...
`celestial-clouds.webp` is the active decorative background in `web/theme.css`, generated using the built-in ImageGen tool at the user’s request for a brighter daytime scene.

- Dimensions: 1536 × 1024, WebP, 287,622 bytes.
- Generation brief: bright clear blue sky, luminous white cloud sea, floating forested mountain islands, Chinese immortal palaces on the right, waterfalls falling into clouds and sunlit jade greenery; cinematic, serene; airy left side; no text or UI.
- The page has no full-page tint overlay in either theme; headings above the landscape use dark teal for contrast.
